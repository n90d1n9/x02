...
class MasterSlideEditorScreen extends ConsumerStatefulWidget {
  const MasterSlideEditorScreen({Key? key}) : super(key: key);
...
class _MasterSlideEditorScreenState extends ConsumerState<MasterSlideEditorScreen>
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: _buildCanvasArea(selectedLayout, viewMode),
          ),
  ...
  Widget _buildThumbnailPanel(MasterSlide masterSlide, MasterLayout? selectedLayout) {
    return Container(
      width: 220,
  ...
  Widget _buildLayoutThumbnail(MasterLayout layout, bool isSelected, int index) {
  ...
  Widget _buildCanvasArea(MasterLayout? selectedLayout, MasterViewMode viewMode) {
                ...
                children: [
                  ...
                  _buildPropertySection(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        ref.read(masterSlideProvider.notifier).updateLayout(
                          selectedLayout.id,
                  ...
                  _buildPropertySection(
                    ...
                    child: Column(
                      children: [
                        ElevatedButton.icon(
                          onPressed: () => _resetLayoutToDefault(selectedLayout),
            ...
            return ListTile(
              ...
              onTap: () {
                ...
                final newLayout = MasterLayout(
                  ...
                  type: type,
                  placeholders: MasterLayout.getDefaultPlaceholdersForType(type),
                );
  ...
  void _resetLayoutToDefault(MasterLayout layout) {
    final defaultPlaceholders = MasterLayout.getDefaultPlaceholdersForType(layout.type);
    ref.read(masterSlideProvider.notifier).updateLayout(
      layout.id,
