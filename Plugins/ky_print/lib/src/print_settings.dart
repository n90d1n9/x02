      ...
      children: [
        ...
        DropdownButtonFormField<PaperSize>(
          ...
          items: const [
            ...
            DropdownMenuItem(value: PaperSize.legal, child: Text('Legal (8.5 x 14 in)')),
            DropdownMenuItem(value: PaperSize.b5, child: Text('B5 (176 x 250 mm)')),
          ],
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  controller: TextEditingController(text: _pageRange!.start.toString()),
                  onChanged: (value) {
                    final start = int.tryParse(value);
                    if (start != null && start >= 1 && start <= widget.totalPages) {
                      setState(() {
              ...
              Expanded(
                child: TextField(
                  ...
                  controller: TextEditingController(text: _pageRange!.end.toString()),
                  onChanged: (value) {
