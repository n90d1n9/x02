...
class CellSelection {
  ...
  /// Convert from Range to CellSelection
  factory CellSelection.fromRange(Range range) {
    return CellSelection(
      CellAddress(range.startRow, range.startCol),
      CellAddress(range.endRow, range.endCol),
    );
  }
