...
class SheetConditionalFormatEvaluator {
  ...
  static bool _matches(ConditionalFormatRule rule, String rawValue) {
    ...
    return switch (rule.condition) {
      ...
      ConditionalFormatCondition.between => false, // TODO: Implement between comparison
      ConditionalFormatCondition.dateOccurring => false, // TODO: Implement date comparisons
      ConditionalFormatCondition.duplicateValues => false,
      ConditionalFormatCondition.aboveAverage => false,
      ConditionalFormatCondition.belowAverage => false,
      ConditionalFormatCondition.topItems => false,
      ConditionalFormatCondition.bottomItems => false,
      ConditionalFormatCondition.topPercent => false,
      ConditionalFormatCondition.bottomPercent => false,
      _ => false,
    };
  }
