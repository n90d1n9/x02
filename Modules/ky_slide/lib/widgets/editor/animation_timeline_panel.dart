...
class AnimationTimelinePanel extends ConsumerStatefulWidget {
  ...
  const AnimationTimelinePanel({super.key, required this.slideId});
...
class _AnimationTimelinePanelState
    extends ConsumerState<AnimationTimelinePanel> {
  ...
  Widget _buildPlaybackButton() {
    ...
    return ElevatedButton.icon(
      ...
      icon: Icon(isPlaying ? Icons.stop : Icons.play_arrow, size: 16),
    ...
    switch (value) {
      ...
      case 'duplicate':
        _timelineService.updateAnimation(
          ...
          order:
              _timelineService
                  .getAnimationsForSlide(widget.slideId)
                  .indexOf(animation) +
              1,
        );
        break;
