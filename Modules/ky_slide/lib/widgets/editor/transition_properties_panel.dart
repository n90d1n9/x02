...
class TransitionPropertiesPanel extends ConsumerStatefulWidget {
  ...
  const TransitionPropertiesPanel({super.key, required this.slideId});
...
class _TransitionPropertiesPanelState
  ...
  Widget build(BuildContext context) {
    ...
    final currentTransition =
        service.getTransitionForSlide(widget.slideId) ??
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: [
              const DropdownMenuItem(value: 'none', child: Text('[No Sound]')),
              const DropdownMenuItem(value: 'chime', child: Text('Chime')),
              const DropdownMenuItem(value: 'click', child: Text('Click')),
              const DropdownMenuItem(value: 'explode', child: Text('Explode')),
            ],
            onChanged: (value) {
  ...
  void _showApplyToAllDialog(
    ...
    SlideTransitionService service,
  ) {
    showDialog(
      context: context,
