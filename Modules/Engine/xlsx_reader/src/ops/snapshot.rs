...
use crate::{
    SheetEdit, SheetGrid, SheetOperation, SheetOperationLog, SheetSnapshot, XLSX_READER_ID,
};
...
pub fn sheet_snapshot(
    ...
    OfficeSnapshot::new(XLSX_READER_ID, document_id, sequence, timestamp_ms, grid)
