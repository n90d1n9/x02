/**
 * xlsx_reader.h — C header for the parser-xlsx Rust library FFI layer.
 *
 * Build the library with:
 *   cargo build --release --features ffi
 *
 * Link against:
 *   -L./target/release -lparser-xlsx
 *
 * Example compile:
 *   gcc main.c -o main -L./target/release -lparser-xlsx -Wl,-rpath,./target/release
 */
