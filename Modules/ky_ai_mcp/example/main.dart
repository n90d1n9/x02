...
Future<void> runWebSocketExample() async {
  ...
  print(
    '⚠️ WebSocket example commented out - add web_socket_channel dependency',
  );
}
...
Future<void> runCustomToolExample() async {
  ...
  final toolsListRequest = {'jsonrpc': '2.0', 'id': 2, 'method': 'tools/list'};
...
Future<void> runKyDocsIntegrationExample() async {
  ...
  */
  ...
  print(
    '⚠️ ky_docs integration example commented - requires ky_docs dependency',
  );
}
...
Future<void> runKyAICoreIntegrationExample() async {
  ...
  */
  ...
  print(
    '⚠️ ky_ai_core integration example commented - requires ky_ai_core dependency',
  );
}
